...
**原因**是没有设置障碍物遮挡，可参考CSDN博客[【如何在SUMO中绘制建筑物（实现Obstacle功能）】](https://blog.csdn.net/weixin_36766000/article/details/121167799)分析。此时我们使用netedit工具绘制一些建筑物遮挡保存为`xxx.poly.xml`文件即可。
...
- 启动 SUMO GUI 并监听 TCP 端口，供 OMNeT++ 连接：
```shell
